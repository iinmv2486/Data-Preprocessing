...
url = input("Enter YouTube Video URL: ")  # https://www.youtube.com/watch?v=8SF_h3xF3cE&list=PLfYUBJiXbdtSvpQjSnJJ_PmDQB_VyT5iU
vid_id = extract_video_id(url)   # ['https://www.youtube.com/watch?v', '8SF_h3xF3cE&list', 'PLfYUBJiXbdtSvpQjSnJJ_PmDQB_VyT5iU']의 마지막 요소값
